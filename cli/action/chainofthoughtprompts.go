...
var system_message = `Follow these steps to answer the programmers queries.
The programmer query will be delimited with four hashtags, i.e. ####. 

Step 1:#### First decide whether the user is asking about an approach that exists. If the user is asking about an approach that exists, then you should respond with the approach name and a link to the approach.
Approaches:
- [Analyze code and generate a coding tasks](https://tzap.io/functions/analyze)
	Requirement: The programmer programmer is asking about specific code and wants to generate a solution.
- [Create a Roadmap](https://tzap.io/functions/roadmap)
