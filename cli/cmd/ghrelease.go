...
The release is then created on GitHub using the title and notes generated by ChatGPT.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		t := tzap.
			NewWithConnector(tzapconnect.WithConfig(config.Configuration{OpenAIModel: modelMap[settings.Model]})).
			SetHeader(fmt.Sprintf(`Be creative and output a GitHub release using the JSON template. Use titles: Use cases, Features, Changes. Please include the compare tag URL.
