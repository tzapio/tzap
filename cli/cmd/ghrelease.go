...
The release is then created on GitHub using the title and notes generated by ChatGPT.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		t := cmdutil.GetTzapFromContext(cmd.Context()).
			AddSystemMessage(fmt.Sprintf(`Be creative and output a GitHub release using the JSON workflow. Use titles: Use cases, Features, Changes. Please include the compare tag URL.
