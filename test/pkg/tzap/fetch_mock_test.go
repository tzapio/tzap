...
func (tg *mockTG) SearchWithEmbedding(ctx context.Context, project string, embedding types.QueryFilter, k int) (types.SearchResults, error) {
	return types.SearchResults{}, nil
}
func (tg *mockTG) AddEmbeddingDocument(ctx context.Context, project string, docID string, embedding [1536]float32, metadata types.Metadata) error {
	return nil
}
func (tg *mockTG) GetEmbeddingDocument(ctx context.Context, project string, docID string) (types.Vector, bool, error) {
	return types.Vector{}, false, nil
}
func (tg *mockTG) DeleteEmbeddingDocument(ctx context.Context, project string, docID string) error {
	return nil
}
func (tg *mockTG) DeleteEmbeddingDocuments(ctx context.Context, project string, ids []string) error {
	return nil
}
func (tg *mockTG) ListAllEmbeddingsIds(ctx context.Context, project string) (types.SearchResults, error) {
	return types.SearchResults{}, nil
}
