...
func (x *CompletionArgs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompletionArgs) ProtoMessage() {}

func (x *CompletionArgs) ProtoReflect() protoreflect.Message {
	mi := &file_completion_proto_msgTypes[0]
...
// Deprecated: Use CompletionArgs.ProtoReflect.Descriptor instead.
func (*CompletionArgs) Descriptor() ([]byte, []int) {
	return file_completion_proto_rawDescGZIP(), []int{0}
}

func (x *CompletionArgs) GetThread() []*Message {
	if x != nil {
		return x.Thread
	}
	return nil
...
type CompletionRequest struct {
	...
	CompletionArgs *CompletionArgs `protobuf:"bytes,1,opt,name=completionArgs,proto3" json:"completionArgs,omitempty"`
}
...
func (x *CompletionRequest) GetCompletionArgs() *CompletionArgs {
	if x != nil {
		return x.CompletionArgs
	}
	return nil
}
...
func (x *CompletionResponse) GetThread() []*Message {
	if x != nil {
		return x.Thread
	}
	return nil
...
var file_completion_proto_rawDesc = []byte{
	...
	,
...
var file_completion_proto_goTypes = []interface{}{
	(*CompletionArgs)(nil),     // 0: actionpb.CompletionArgs
	(*CompletionRequest)(nil),  // 1: actionpb.CompletionRequest
	(*CompletionResponse)(nil), // 2: actionpb.CompletionResponse
	(*Message)(nil),            // 3: actionpb.Message
}
var file_completion_proto_depIdxs = []int32{
	3, // 0: actionpb.CompletionArgs.thread:type_name -> actionpb.Message
	0, // 1: actionpb.CompletionRequest.completionArgs:type_name -> actionpb.CompletionArgs
	3, // 2: actionpb.CompletionResponse.thread:type_name -> actionpb.Message
